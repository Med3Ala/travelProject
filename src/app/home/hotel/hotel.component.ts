...
export class HotelComponent implements OnInit {
  ...
  SearchHotels(){
    ...
    this.homeService.SearchHotels(this.country, this.country, this.review[0], this.price[0], this.review[0], this.rate[0], checkInDate.getTime(), checkOutDate.getTime()).subscribe((data:any)=>{
